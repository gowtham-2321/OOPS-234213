...
void Planets:: setMass() { //Member Functions - inline functions
...
void Planets:: setRadius() { //Member Functions - inline functions
...
double Planets:: calculateEscapeVelocity(){ //Member Functions - inline functions
